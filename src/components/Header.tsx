  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
        scrolled
          ? 'bg-transparent lg:bg-zinc-950/95 lg:backdrop-blur-md border-b border-transparent lg:border-zinc-900 lg:shadow-xl py-3'
          : 'bg-transparent lg:bg-zinc-950/80 lg:backdrop-blur-md border-b border-transparent lg:border-white/5 py-4'
      }`}
    >
      ...
      <div 
        className={`lg:hidden fixed inset-0 w-full h-[100dvh] bg-zinc-950/95 backdrop-blur-xl flex flex-col justify-between pt-28 pb-8 px-6 transition-transform duration-500 ease-in-out ${
